<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        <div id="collapseProduct" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="<?= base_url() ?>/product">Product List</a>
                <a class="collapse-item" href="<?= base_url() ?>/product/create">Add Product</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="collapseSupplier" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Suppliers Menu:</h6>
                <a class="collapse-item" href="<?= base_url() ?>/supplier">Supplier List</a>
                <a class="collapse-item" href="<?= base_url() ?>/supplier/create">Add Supplier</a>
            </div>
        </div>
    </li>
